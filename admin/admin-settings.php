 ...
 *
 * Loaded by AWB_Settings::render_settings_page().
 *
 * @package AWBStarter
 */
            ...
            <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" class="awb-form" id="awb-tokens-form">
                                    ...
                                    <?php if ($field['type'] === 'color') : ?>
                                        <div class="awb-color-input">
                                            <input type="color"
                                                ...
                                                value="<?php echo esc_attr($value ?: $field['default']); ?>"
                ...
                <div class="awb-form__section awb-form__section--preview">
                    <div class="awb-form__section-header">
                        ...
                        <p>This <code>:root</code> block is added to every frontend page automatically.</p>
                    </div>
            ...
            <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>"
                ...
                <div class="awb-form__section">
                    ...
                    <div class="awb-token-grid">
                        <?php
                        $font_fields = [
                            'awb_custom_font_regular' => ['label' => 'Regular (400)', 'accept' => '.woff,.woff2,.ttf,.otf'],
                            'awb_custom_font_medium'  => ['label' => 'Medium (500)',  'accept' => '.woff,.woff2,.ttf,.otf'],
                            'awb_custom_font_bold'    => ['label' => 'Bold (700)',    'accept' => '.woff,.woff2,.ttf,.otf'],
                        ];
                        foreach ($font_fields as $option_name => $field) :
                                ...
                                <div class="awb-file-input">
                                    ...
                                    <?php if ($current) : ?>
                                        <div class="awb-current-file">
                                            ...
                                            <button type="button"
                                                class="awb-btn awb-btn--danger awb-btn--sm awb-delete-font"
                                                data-font-type="<?php echo esc_attr($font_type); ?>"
                                                data-nonce="<?php echo esc_attr(wp_create_nonce('awb_delete_font_nonce')); ?>">
                                                Delete
                                            </button>
                                        </div>
                                    <?php else : ?>
        ...
        <?php elseif ($active_tab === 'scaffold') : ?>
            <div class="awb-scaffold">
                ...
                <div class="awb-scaffold__grid">
                    <?php
                    $scaffolds = [
                        ['id' => 'business',  'icon' => '⬡', 'label' => 'Business',  'pages' => ['Home', 'About', 'Services', 'Contact'], 'desc' => '4 pages, contact form pattern, services section'],
                        ['id' => 'portfolio', 'icon' => '◈', 'label' => 'Portfolio', 'pages' => ['Home', 'Work', 'About', 'Contact'],      'desc' => '4 pages, project grid pattern, hero section'],
                        ['id' => 'landing',   'icon' => '✦', 'label' => 'Landing',   'pages' => ['Home'],                                  'desc' => '1 full-page layout, all sections stacked'],
                    ];
                    ?>
                ...
                <div class="awb-ai__layout">
                    <div class="awb-ai__controls">
                        <div class="awb-form__section">
                            ...
                            <div class="awb-ai-context">
                                <div class="awb-field">
                                    ...
                                    <input type="text" id="awb-ai-business-name" placeholder="Vakman Builders"
                                        value="<?php echo esc_attr(get_option('awb_ai_business_name', '')); ?>" />
                                </div>
                                <div class="awb-field">
                        ...
                        <div class="awb-form__section">
                            ...
                            <div class="awb-field">
                                ...
                                <textarea id="awb-ai-prompt" class="awb-editor" rows="5"
                                    placeholder="A hero section for a construction company with a bold headline, short subtext, and a 'Get a quote' button"></textarea>
                            </div>
                    ...
                    <div class="awb-ai__output">
                        ...
                        <div class="awb-ai__history" id="awb-ai-history">
                            <h4>Recent generations
                                <button type="button" class="awb-btn awb-btn--ghost awb-btn--xs" id="awb-ai-clear-history">Clear all</button>
                            </h4>
                ...
                <?php else : ?>
                    ...
                    <div class="awb-patterns__grid" id="awb-patterns-grid">
                        <?php foreach ($all_patterns as $pattern) :
                            ...
                            $is_synced = AWB_Pattern_Sync::is_synced($exportable_name);
                            ?>
                            <div class="awb-pattern-card"
                                ...
                                <div class="awb-pattern-card__sync">
                                    <label class="awb-sync-toggle" title="<?php echo $is_synced ? 'Sync is ON' : 'Sync is OFF'; ?>">
                                        <input type="checkbox"
                                            ...
                                            data-name="<?php echo esc_attr($exportable_name); ?>"
                                ...
                                <div class="awb-pattern-card__footer">
                                    ...
                                    <?php endif; ?>
                                    <?php if ($is_synced) : ?>
                                        <button type="button" class="awb-btn awb-btn--ghost awb-btn--sm awb-copy-synced" data-name="<?php echo esc_attr($exportable_name); ?>" title="Copy synced embed"><i class="fas fa-link"></i> Embed</button>
                                        <button type="button" class="awb-btn awb-btn--ghost awb-btn--sm awb-manage-sync" data-name="<?php echo esc_attr($exportable_name); ?>" data-title="<?php echo esc_attr($pattern['title']); ?>" title="Sync pages"><i class="fas fa-sync"></i> Sync</button>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endforeach; ?>
